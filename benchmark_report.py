...
def plot_sub_action(video_data, label_x, label_y, save_path, grid=False):
...
def plot_sub_eye_close(video_data, label_x, label_y, save_path, grid=False):
    data_frame  = video_data[ATTR_FRAME_ID]
    data_score  = video_data[ATTR_SCORE]
    data_start  = video_data[ATTR_START_THRESHOLD]
    data_action = video_data[ATTR_ACTION_THRESHOLD]
...
if __name__ == "__main__":
    ...
    if video_name == "" or action_name == "":
        ...
        if action_name == ACTION_NAME_EYE_CLOSE:
            plot_sub_eye_close(video_data, ATTR_FRAME_ID, ATTR_SCORE, video_name)
        else:
            plot_sub_action(video_data, ATTR_FRAME_ID, ATTR_SCORE, video_name)